...
function ProductDetails({data}) {
  ...
  return (
    <div>
      ...
      <div className={`bg-[url(${data.img})] relative h-[500px] w-full bg-cover`}>
        <div className='bg-black/50 text-white rounded-t-4xl absolute bottom-0 p-5 left-0 right-0 '>
        ...
        <span className='inline-block p-4 rounded-2xl bg-[#141921]'>
